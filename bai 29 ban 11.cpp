...
private:
    ...
    void inMaHoa(Nut* goc, string str) {
        if (!goc)
            return;
        ...
        inMaHoa(goc->trai, str + "0");
        inMaHoa(goc->phai, str + "1");
    }
...
int main() {
    string str;
     str="ABABBCBBDEEEABABBAEEDDCCABBBCDEEDCBCCCCDBBBCAAA";
    ...
    cout << "Ma Huffman cua tung ky tu: " << endl;
    huff.inMaHoa();
